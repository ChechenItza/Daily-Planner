#ifndef MYCUSTOMSHADOWEFFECT_H
#define MYCUSTOMSHADOWEFFECT_H

#include <QGraphicsDropShadowEffect>
#include <QGraphicsEffect>

class MyCustomShadowEffect : public QGraphicsEffect
{
    Q_OBJECT
public:
    explicit MyCustomShadowEffect(QObject *parent = 0);
