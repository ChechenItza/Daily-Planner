#include "mycustomshadoweffect.h"
#include <QPainter>
// #include <QGraphicsEffect>

MyCustomShadowEffect::MyCustomShadowEffect(QObject *parent) :
...
void MyCustomShadowEffect::draw(QPainter* painter)
{
...
QRectF MyCustomShadowEffect::boundingRectFor(const QRectF& rect) const
{
